...
- **Inline text editing:** Double-click any plot title or axis label to edit it in place with an inline input overlay that mirrors the chart font and automatically resizes to match your text as you type, streamlining quick annotation tweaks without modal prompts.【F:js/shared/dom.js†L23-L210】【F:css/style.css†L862-L883】
