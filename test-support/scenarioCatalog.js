...
const SCENARIO_CATALOG = Object.freeze([
  ...
  Object.freeze({ id: 'OWN.same-type-switching.all-components', kind: 'contract', contract: 'OWN', components: ['*'] }),
  Object.freeze({ id: 'OWN.component-dom-binding', kind: 'contract', contract: 'OWN', components: ['*'] }),
  Object.freeze({ id: 'OWN.config-isolation.all-components', kind: 'contract', contract: 'OWN', components: ['*'] }),
  Object.freeze({ id: 'OWN.cross-browser-feature-matrix', kind: 'contract', contract: 'OWN', components: ['*'] }),
  Object.freeze({ id: 'PERSIST.explicit-component-mutations', kind: 'contract', contract: 'PERSIST', components: ['*'] }),
  Object.freeze({ id: 'PERSIST.session-payload-write-through', kind: 'contract', contract: 'PERSIST', components: ['*'] }),
  ...
  Object.freeze({ id: 'LAYOUT.pca-legend-envelope', kind: 'contract', contract: 'LAYOUT', components: ['pca'] }),
  Object.freeze({ id: 'LAYOUT.heatmap-label-font-resize', kind: 'contract', contract: 'LAYOUT', components: ['heatmap'] }),
  Object.freeze({ id: 'LAYOUT.legend-viewport-invariant', kind: 'contract', contract: 'LAYOUT', components: ['*'] }),
  Object.freeze({ id: 'PERSIST.pca-color-scheme-roundtrip', kind: 'contract', contract: 'PERSIST', components: ['pca'] }),
  Object.freeze({ id: 'CACHE.pca-view-only-rotation', kind: 'contract', contract: 'CACHE', components: ['pca'] }),
  Object.freeze({ id: 'CACHE.pca-example-rebind', kind: 'contract', contract: 'CACHE', components: ['pca'] }),
  Object.freeze({ id: 'CACHE.scatter-example-rebind', kind: 'contract', contract: 'CACHE', components: ['scatter'] }),
  Object.freeze({ id: 'CACHE.tab-switch-reuse', kind: 'contract', contract: 'CACHE', components: ['*'] }),
  Object.freeze({ id: 'CACHE.reopened-first-interaction', kind: 'contract', contract: 'CACHE', components: ['*'] }),
  Object.freeze({ id: 'PERSIST.venn-empty-payload-defaults', kind: 'contract', contract: 'PERSIST', components: ['venn'] }),
  Object.freeze({ id: 'PERSIST.pie-percent-labels', kind: 'contract', contract: 'PERSIST', components: ['pie'] }),
  Object.freeze({ id: 'OWN.pie-tab-host-isolation', kind: 'contract', contract: 'OWN', components: ['pie'] }),
  ...
  Object.freeze({ id: 'OWN.surface-tab-context', kind: 'contract', contract: 'OWN', components: ['surface'] }),
  Object.freeze({ id: 'OWN.venn-runtime-isolation', kind: 'contract', contract: 'OWN', components: ['venn'] }),
  Object.freeze({ id: 'OWN.venn-upset-controls', kind: 'contract', contract: 'OWN', components: ['venn'] }),
  Object.freeze({ id: 'OWN.heatmap-tab-context', kind: 'contract', contract: 'OWN', components: ['heatmap'] }),
  Object.freeze({ id: 'CACHE.heatmap-render-cache-restore', kind: 'contract', contract: 'CACHE', components: ['heatmap'] }),
  Object.freeze({ id: 'CACHE.heavy-canvas-recovery', kind: 'contract', contract: 'CACHE', components: ['box', 'scatter'] }),
  Object.freeze({ id: 'OWN.line-view-lifecycle', kind: 'contract', contract: 'OWN', components: ['line'] }),
  Object.freeze({ id: 'OWN.pca-view-controls', kind: 'contract', contract: 'OWN', components: ['pca'] }),
  Object.freeze({ id: 'OWN.venn-tab-opening', kind: 'contract', contract: 'OWN', components: ['venn'] }),
  Object.freeze({ id: 'PERSIST.box-column-style-identity', kind: 'contract', contract: 'PERSIST', components: ['box'] }),
  Object.freeze({ id: 'PERSIST.box-column-reorder-undo', kind: 'contract', contract: 'PERSIST', components: ['box'] }),
  Object.freeze({ id: 'STATS.box-dual-tab-isolation', kind: 'contract', contract: 'STATS', components: ['box'] }),
  Object.freeze({ id: 'STATS.box-dual-tab-no-crash', kind: 'contract', contract: 'STATS', components: ['box'] }),
  Object.freeze({ id: 'STATS.box-duplicate-recompute', kind: 'contract', contract: 'STATS', components: ['box'] }),
  Object.freeze({ id: 'OWN.box-example-controls', kind: 'contract', contract: 'OWN', components: ['box'] }),
  Object.freeze({ id: 'OWN.box-flip-isolation', kind: 'contract', contract: 'OWN', components: ['box'] }),
  Object.freeze({ id: 'LAYOUT.box-axis-role-tick-length', kind: 'contract', contract: 'LAYOUT', components: ['box'] }),
  Object.freeze({ id: 'LAYOUT.box-flip-resize', kind: 'contract', contract: 'LAYOUT', components: ['box'] }),
  Object.freeze({ id: 'OWN.box-formula-editor', kind: 'contract', contract: 'OWN', components: ['box'] }),
  ...
  Object.freeze({ id: 'ASYNC.inactive-owner-completion', kind: 'contract', contract: 'ASYNC', components: ['box', 'scatter'] }),
  ...
  Object.freeze({ id: 'PERSIST.component-reopen-fidelity', kind: 'contract', contract: 'PERSIST', components: ['*'] }),
  Object.freeze({ id: 'PERSIST.notes-and-dataviews', kind: 'contract', contract: 'PERSIST', components: ['*'] }),
  Object.freeze({ id: 'REC.archive-recovery-matrix', kind: 'contract', contract: 'REC', components: ['*'] }),
