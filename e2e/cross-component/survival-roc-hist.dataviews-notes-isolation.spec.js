...
for (const component of CASES) {
  test(`${component.type} DataViews, notes, and controls stay isolated across same-type switch, reopen, and recovery`, async ({ page }, testInfo) => {
    ...
    const archivePath = await captureArchive(page, `${component.type}-dataviews-notes-isolation`, testInfo.outputPath(`${component.type}-dataviews-notes-isolation.graph`));
