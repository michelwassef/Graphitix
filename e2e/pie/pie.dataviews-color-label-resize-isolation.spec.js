...
async function activateTab(page, tabId) {
  ...
  await waitForComponentOwnerReady(page, 'pie', {
    expectedTabId: tabId,
...
test('Pie DataViews, colors, labels, and finalized resize stay isolated across same-type tabs and reopen', async ({ page }, testInfo) => {
