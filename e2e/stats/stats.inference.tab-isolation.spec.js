...
test('pre-analysis alpha is tab-owned and survives same-component archive reopen', async ({ page }, testInfo) => {
  ...
  const archivePath = await captureWorkspaceArchive(page, testInfo.outputPath('stats-inference-isolation.graph'));
