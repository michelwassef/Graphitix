...
async function assertZoomPresentation(page, component, readyExpression, options = {}) {
  ...
  if(component === 'line'){
    await waitForOwnerProjection(page, component, '#lineSvg', {
  ...
  await waitForObservationWindow(page, Number(options.settleMs) || 1_800, {
    label: `${component} zoom delayed-render window`
  });
