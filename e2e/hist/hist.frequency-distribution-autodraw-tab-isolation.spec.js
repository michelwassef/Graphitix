...
test('Histogram frequency, distribution, and manual-render state stay isolated across same-type tabs and reopen', async ({ page }, testInfo) => {
...
test('Histogram async table import commits to the originating tab while inactive', async ({ page }, testInfo) => {
  ...
  const csvPath = testInfo.outputPath('hist-origin-import.csv');
