...
test('survival covariate controls stay isolated across same-component tabs and reopen', async ({ page }, testInfo) => {
  ...
  const archivePath = await captureWorkspaceArchive(page, testInfo.outputPath('survival-covariate-reopen-isolation.graph'));
