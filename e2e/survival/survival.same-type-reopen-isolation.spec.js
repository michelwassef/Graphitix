...
test('survival same-type controls and stats stay isolated across tab switch and reopen', async ({ page }, testInfo) => {
  ...
  const archivePath = await captureWorkspaceArchive(page, testInfo.outputPath('survival-same-type-reopen-isolation.graph'));
