...
test('survival style, reporting, advisor, and tab-scoped font refresh survive switch and reopen', async ({ page }, testInfo) => {
  ...
  const archivePath = await captureWorkspaceArchive(page, testInfo.outputPath('survival-style-report-deferred-isolation.graph'));
