...
// Diagnostic-only exploration. It reports missing controls and timing, but it
// is not an acceptance contract and must not certify behavior.
async function runDiagnosticComponentExercise(page, component) {
