(function() {
  ...
  const GRAPH_TYPES = [
    { type: 'box', label: 'Distribution Charts', hint: 'Group comparisons', description: 'Compare groups with box plots, violin plots, bar charts, or individual value strips, plus statistical tests.', icon: '<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="20" width="8" height="30" fill="#3b82f6"/><rect x="20" y="14" width="8" height="36" fill="#3b82f6"/><rect x="32" y="24" width="8" height="26" fill="#3b82f6"/><rect x="44" y="18" width="8" height="32" fill="#3b82f6"/></svg>' },
    ...
    { type: 'hist', label: 'Histogram / Density Plot', hint: 'Frequency distribution', description: 'Summarize univariate distributions with adjustable binning, density plots, PDF/CDF overlays, and distribution fits.', icon: '<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="32" width="7" height="20" fill="#3b82f6"/><rect x="16" y="20" width="7" height="32" fill="#3b82f6"/><rect x="24" y="16" width="7" height="36" fill="#3b82f6"/><rect x="32" y="18" width="7" height="34" fill="#3b82f6"/><rect x="40" y="24" width="7" height="28" fill="#3b82f6"/><rect x="48" y="36" width="7" height="16" fill="#3b82f6"/></svg>' },
