...
(function(global){
  ...
  function draw(){
    ...
    if(type==='stacked'){
      ...
      const marginTop=fs+20; const marginBottom=40; const marginLeft=fs*5; const chartWidth=svgWidth-marginLeft-20; const chartHeight=svgHeight-marginTop-marginBottom;
